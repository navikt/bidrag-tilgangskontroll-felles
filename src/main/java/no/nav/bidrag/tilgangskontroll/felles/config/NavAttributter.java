...
public final class NavAttributter {
  ...
  public static final String SUBJECT_FELLES_AZURE_JWT_TOKEN_BODY = "no.nav.abac.attributter.environment.felles.azure_jwt_token_body";
  public static final String SUBJECT_FELLES_SUBJECT_TYPE = "no.nav.abac.attributter.subject.felles.subjectType";
  public static final String SUBJECT_FELLES_SUBJECT_ID = "urn:oasis:names:tc:xacml:1.0:subject:subject-id";

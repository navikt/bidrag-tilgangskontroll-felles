package no.nav.bidrag.tilgangskontroll.felles.service;

import static no.nav.bidrag.tilgangskontroll.felles.SecurityUtils.hentSubjectIdFraAzureToken;
import static no.nav.bidrag.tilgangskontroll.felles.SecurityUtils.henteIssuer;
import static no.nav.bidrag.tilgangskontroll.felles.SecurityUtils.parseIdToken;
import static no.nav.bidrag.tilgangskontroll.felles.config.StandardAttributter.ACTION_ID;
...
import no.nav.bidrag.tilgangskontroll.felles.annotation.attribute.Abac;
